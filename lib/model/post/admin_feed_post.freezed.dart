...
AdminFeedPost _$AdminFeedPostFromJson(Map<String, dynamic> json) {
  return _AdminFeedPost.fromJson(json);
}

/// @nodoc
class _$AdminFeedPostTearOff {
  const _$AdminFeedPostTearOff();
  ...
  AdminFeedPost fromJson(Map<String, Object> json) {
    return AdminFeedPost.fromJson(json);
  }
}

/// @nodoc
const $AdminFeedPost = _$AdminFeedPostTearOff();

/// @nodoc
mixin _$AdminFeedPost {
  ...
  @JsonKey(ignore: true)
  $AdminFeedPostCopyWith<AdminFeedPost> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AdminFeedPostCopyWith<$Res> {
  factory $AdminFeedPostCopyWith(
          AdminFeedPost value, $Res Function(AdminFeedPost) then) =
      _$AdminFeedPostCopyWithImpl<$Res>;
  $Res call(
      {int id,
      int authorId,
      double score,
...
/// @nodoc
class _$AdminFeedPostCopyWithImpl<$Res>
    implements $AdminFeedPostCopyWith<$Res> {
  _$AdminFeedPostCopyWithImpl(this._value, this._then);

  final AdminFeedPost _value;
  // ignore: unused_field
  final $Res Function(AdminFeedPost) _then;
...
/// @nodoc
abstract class _$AdminFeedPostCopyWith<$Res>
    implements $AdminFeedPostCopyWith<$Res> {
  factory _$AdminFeedPostCopyWith(
          _AdminFeedPost value, $Res Function(_AdminFeedPost) then) =
      __$AdminFeedPostCopyWithImpl<$Res>;
  @override
  $Res call(
      {int id,
      int authorId,
...
/// @nodoc
class __$AdminFeedPostCopyWithImpl<$Res>
    extends _$AdminFeedPostCopyWithImpl<$Res>
    implements _$AdminFeedPostCopyWith<$Res> {
  __$AdminFeedPostCopyWithImpl(
      _AdminFeedPost _value, $Res Function(_AdminFeedPost) _then)
      : super(_value, (v) => _then(v as _AdminFeedPost));

  @override
  _AdminFeedPost get _value => super._value as _AdminFeedPost;
...
class _$_AdminFeedPost implements _AdminFeedPost {
  _$_AdminFeedPost(
      {required this.id,
  ...
  factory _$_AdminFeedPost.fromJson(Map<String, dynamic> json) =>
      _$_$_AdminFeedPostFromJson(json);
  ...
  @override
  String toString() {
    return 'AdminFeedPost(id: $id, authorId: $authorId, score: $score, profileName: $profileName, title: $title, firstContentText: $firstContentText, secondContentText: $secondContentText, commentCount: $commentCount, likeCount: $likeCount, viewCount: $viewCount, firstContentVoteCount: $firstContentVoteCount, secondContentVoteCount: $secondContentVoteCount, createdAt: $createdAt, mediaContentOrders: $mediaContentOrders, mediaTypes: $mediaTypes, mediaUrls: $mediaUrls)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _AdminFeedPost &&
  ...
  @JsonKey(ignore: true)
  @override
  _$AdminFeedPostCopyWith<_AdminFeedPost> get copyWith =>
      __$AdminFeedPostCopyWithImpl<_AdminFeedPost>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$_$_AdminFeedPostToJson(this);
  }
}

abstract class _AdminFeedPost implements AdminFeedPost {
  factory _AdminFeedPost(
      {required int id,
      required int authorId,
      required double score,
      required String profileName,
      ...
      required String? mediaContentOrders,
      required String? mediaTypes,
      required String? mediaUrls}) = _$_AdminFeedPost;

  factory _AdminFeedPost.fromJson(Map<String, dynamic> json) =
      _$_AdminFeedPost.fromJson;
