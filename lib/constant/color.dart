...
LinearGradient kPostGradient70 = LinearGradient(
  ...
  colors: [
    Color(0xff52FFCD).withOpacity(0.7),
    Color(0xff824AFF).withOpacity(0.7),
  ],
);
LinearGradient kPostGradient50 = LinearGradient(
  begin: Alignment.centerLeft,
  end: Alignment.centerRight,
  colors: [
    Color(0xff52FFCD).withOpacity(0.5),
    Color(0xff824AFF).withOpacity(0.5),
  ],
);
